...
The useful `%%` syntax means SBT will select the appropriate binary for your Scala version, and `2.4` is the
...
(see [application.conf](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/conf/application.conf) for a complete example)
...
The [play-recaptcha v2 example application](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4) is internationalised to two languages (English, French) as an example.
...
(see [form.scala.html](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/app/views/form.scala.html) for a complete example)
...
(see [invisibleForm.scala.html](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/app/views/invisibleForm.scala.html) for a complete example)
...
(see [messages](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/conf/messages) for a complete example)
...
(see [ExampleForm.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/app/controllers/ExampleForm.scala) for a complete example,
and [ExampleFormSpec.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/test/controllers/ExampleFormSpec.scala) for example unit tests using specs2)
...
(see [JavascriptForm.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/app/controllers/JavascriptForm.scala) for a complete example,
see [JavascriptFormSpec.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/test/controllers/JavascriptFormSpec.scala) for example unit tests using specs2)
...
(see [InvisibleForm.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/app/controllers/InvisibleForm.scala) for a complete example,
and [InvisibleFormSpec.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/test/controllers/InvisibleFormSpec.scala) for example unit tests using specs2)
...
(see [InvisibleForm.scala](https://github.com/chrisnappin/play-recaptcha-v2-example/tree/release-2.4/app/controllers/InvisibleForm.scala) for a complete example with action composition) 
